    ...
    if (modalType === "dataDiri") {
      try {
        ...
        const updateData = {
          ...
          birth_place: (
            modalFormData.tempatLahir ||
            currentData.tempatLahir ||
            ""
          ).trim(),
          date_of_birth:
            modalFormData.tanggalLahir || currentData.tanggalLahir || null,
          address: (
            modalFormData.alamatRumah ||
            currentData.alamatRumah ||
            ""
          ).trim(),
          marital_status_id: mapMaritalStatusToId(
            modalFormData.statusPernikahan || currentData.statusPernikahan || ""
          ),
          age: parseInt(modalFormData.umur || currentData.umur || "0"),
          blood_group: (
            modalFormData.golonganDarah ||
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-4">
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                      ...
                      <p className="text-sm text-blue-700">
                        HPHT (Hari Pertama Haid Terakhir) digunakan untuk
                        menghitung usia kehamilan dan perkiraan tanggal lahir.
                      ...
                      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                          ...
                          <div>
                            ...
                            <p className="text-green-800">
                              {
                                calculatePregnancyInfo(modalFormData.hpht)
                                  .trimester
                              }
                            </p>
                          </div>
      ...
      {isLoadingInfo ? (
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <InfoRow
                  label="Nama"
                  value={currentData.nama || "Belum diisi"}
                />
                <InfoRow
                  label="Tempat Lahir"
                  value={currentData.tempatLahir || "Belum diisi"}
                />
                <InfoRow
                  label="Alamat Rumah"
                  value={currentData.alamatRumah || "Belum diisi"}
                />
                <InfoRow
                  label="Umur"
                  value={
                    currentData.umur
                      ? `${currentData.umur} tahun`
                      : "Belum diisi"
                  }
                  showSeparator={false}
                />
              ...
              <div>
                <InfoRow
                  label="Nomor Telepon"
                  value={currentData.nomorTelepon || "Belum diisi"}
                />
                <InfoRow
                  label="Tanggal Lahir"
                  value={currentData.tanggalLahir || "Belum diisi"}
                />
                <InfoRow
                  label="Status Pernikahan"
                  value={currentData.statusPernikahan || "Belum diisi"}
                />
                <InfoRow
                  label="Golongan Darah"
                  value={currentData.golonganDarah || "Belum diisi"}
                  showSeparator={false}
                />
              </div>
            </div>
          ...
          <Card
            title="Data Medis"
            onEditClick={
              isMotherRole ? () => openModal("dataMedis") : undefined
            }
          >
            {!isMotherRole && (
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <InfoRow
                  ...
                  value={currentData.riwayatPenyakit || "Tidak ada"}
                />
                <InfoRow
                  label="Tinggi Badan"
                  value={
                    currentData.tinggiBadan
                      ? `${currentData.tinggiBadan} cm`
                      : "Belum diisi"
                  }
                />
                <InfoRow
                  label="Status Imunisasi"
                  value={currentData.statusImunisasi || "Belum diisi"}
                  showSeparator={false}
                />
              </div>
              <div>
                <InfoRow
                  ...
                  value={currentData.riwayatAlergi || "Tidak ada"}
                />
                <InfoRow
                  label="Berat Badan"
                  value={
                    currentData.beratBadan
                      ? `${currentData.beratBadan} kg`
                      : "Belum diisi"
                  }
                />
                <InfoRow
                  label="Riwayat Kehamilan"
                  value={currentData.riwayatKehamilan || "Belum diisi"}
                  showSeparator={false}
                />
              </div>
            </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <InfoRow
                  label="Nama"
                  value={currentData.namaKontak || "Belum diisi"}
                />
                <InfoRow
                  label="Hubungan"
                  value={currentData.hubunganKontak || "Belum diisi"}
                />
              </div>
              <div>
                <InfoRow
                  label="Nomor Telepon"
                  value={currentData.nomorTeleponKontak || "Belum diisi"}
                />
                <InfoRow
                  label="Alamat Kontak Darurat"
                  value={currentData.alamatKontak || "Belum diisi"}
                  showSeparator={false}
                />
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-green-600">
                  Endpoint: GET /inquiry/information | Update: PUT
